...
const reviewRouter = require("./routes/review.js"); //requiring reviews routes
const userRouter = require("./routes/user.js"); //requiring reviews routes
...
app.use("/listings", listingRouter); // for listings routes
